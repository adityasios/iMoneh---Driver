...
extension CompletedVC : UITableViewDataSource{
...
// MARK:- EXT - UITableViewDataSource
extension CompletedVC : UITableViewDelegate{
...
extension CompletedVC {
    private func getOrderList() {
        ...
        let paraTemp : [String:String] = [Parameters.page:"1",Parameters.status:OrderStatus.completed.rawValue]
    ...
    private  func jsonParsingOrderList(json:Any) {
        if let jsonTemp = json as? [String: Any]  {
            ...
            do {
                ...
                print("parsingError comp order = \(parsingError)")
